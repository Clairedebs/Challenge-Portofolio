          ...
          <div className="flex flex-col gap-8 md:gap-12 px-4 md:px-16 mb-16">
            ...
            <div className="flex flex-col md:flex-row gap-6 md:gap-10">
              ...
              <div className="order-1 md:order-2">
                <img src="/work1.svg" alt="workit" className='rounded-lg w-screen h-64 md:h-96 object-cover' />
              </div>
            </div>
            {/* 2 */}
            <div className="flex flex-col md:flex-row gap-6 md:gap-10">
              <div className="order-1">
                <img src="/work2.svg" alt="workit" className='rounded-lg w-screen h-64 md:h-96 object-cover' /> 
              </div>
            ...
            <div className="flex flex-col md:flex-row gap-6 md:gap-10">
              ...
              <div className="order-1 md:order-2">
                <img src="/work3.svg" alt="workit" className='rounded-lg w-screen h-64 md:h-96 object-cover' />
              </div>
            </div>
          </div>
        </div>
